...
const PUBLIC_PATHS = ['/login', '/api/auth', '/consent', '/api/consent', '/api/health', '/kiosk', '/kiosk/update-info', '/kiosk/services', '/api/kiosk', '/api/appointment-reasons', '/api/insurance-companies', '/api/videos', '/api/forms', '/_next', '/favicon']
